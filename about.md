...
## Welcome to the Select the Best Car for your Trip" App, 
...
Source code for ui.R and server.R files are available on the [GitHub](https://github.com/mostaafafarouk/Dataproducts).